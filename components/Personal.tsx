...
const interests: Interest[] = [
  {
    ...
    photos: [
      {
        src: "/mandala.jpg",
        caption: "Mandala Art — hours of deliberate precision",
      },
      {
        src: "/mandala-2.jpg",
        caption: "Every pattern starts from a single centre point",
      },
  ...
  },
  {
    ...
    photos: [
      {
        src: "/hiking-jalori.jpg",
        caption: "Trekking Jalori Pass, Himachal Pradesh",
      },
      {
        src: "/hiking-gorson.jpg",
        caption: "View from Gorson Bugyal Trek, Auli",
      },
      { src: "/Hiking_necklace_point.jpg", caption: "Hiking Necklace Point" },
      {
        src: "/Trek_kalpeshwar_mahadev.jpg",
        caption: "Trek to Kalpeshwar Mahadev, Uttarakhand",
      },
      {
        src: "/Skiing.jpg",
        caption: "First time skiing — commit to the edge or fall",
      },
    ],
  },
  {
    ...
    photos: [
      {
        src: "/Cruise_experience_Halong_Bay.jpg",
        caption: "Cruise experience, Halong Bay, Vietnam",
      },
      {
        src: "/Kayaking_Halong_bay.jpg",
        caption: "Kayaking through limestone karsts, Halong Bay",
      },
      {
        src: "/Ellora_Caves_Art_1.jpg",
        caption: "Ellora Caves — 1,500-year-old rock-cut sculptures",
      },
      {
        src: "/Ellora_Caves_Art_2.jpg",
        caption: "Ellora Caves — carved entirely by hand",
      },
      {
        src: "/Ellora_Caves_Art_3.jpg",
        caption: "Ellora Caves — where art meets devotion",
      },
      {
        src: "/Exploring_coastal_food_in_Thailand.jpg",
        caption: "Coastal seafood, Thailand",
      },
      {
        src: "/Exploring_brewery.jpg",
        caption: "Exploring a local craft brewery",
      },
    ],
  },
  {
    ...
    photos: [
      {
        ...
        caption: "Playing tennis — reading the game, not just the ball",
      },
    ],
  },
  {
    ...
    videoEmbed:
      "https://drive.google.com/file/d/1XA1mJ23f3clMjPX1iZbqhVzMX-8b1LeI/preview",
  },
  {
    name: "Reading Books",
    ...
    photos: [
      {
        ...
        caption: "My current reading collection",
      },
    ],
  },
];
    ...
    <>
      ...
      <div className="mt-4">
        ...
        >
          ...
          {photos.length > 1 && (
            <div
              className="absolute bottom-8 right-2 flex gap-1"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                onClick={prev}
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ color: "#1A1A1A" }}
            >
              Honoured as <strong>National Mathematics Topper 2014</strong>,
              scoring 100/100 in Mathematics across all DAV Public/Model Schools
              in the CBSE Class XII examination. Personally recognised by{" "}
              <strong>Smriti Zubin Irani</strong>, Minister of Human Resource
              Development, Government of India, among over 1 million students
              nationwide.
            </p>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(10,35,66,0.8), transparent)",
                    }}
                  >
          ...
          >
            ...
            ? That question pulled us into hyperreals, infinitesimals, and the
            edges of what standard calculus quietly sweeps under the rug. What
            started as a dorm-room debate became a co-authored research paper
            published in IJMTT.
          </p>
          ...
          <p
            ...
            style={{ color: "#374151" }}
          >
            I don&apos;t do math for grades. I do it because it&apos;s the
        ...
        >
          ...
          >
            From the mathematics of infinity to why certain civilisations
          ...
          >
            Whether sport is more about strategy or mentality. What a mandala
            and a system architecture have in common. How geography quietly
            shapes economies. Pick any thread and I&apos;ll pull on it with you.
          </p>
