  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col-reverse md:flex-row md:items-start md:justify-between gap-10 mb-0">
          ...
          <div className="flex-1">
            <div className="mb-2">
              ...
              >
                <em>
                  My parents spent days picking Mudit. My colleagues took one
                  look and went with MG.
                </em>
              </p>
            </div>
            ...
            <p
              className="mb-8 max-w-xl font-serif-display italic"
              style={{
                fontSize: "1.15rem",
                color: "#0A2342",
                lineHeight: 1.6,
            ...
            >
              Are you solving a problem that creates positive impact? If yes, I
              will be invested with you.
            </p>
            ...
            >
              Software Engineer at Spinny, a Tiger Global-backed $1.4B unicorn.
              Five and a half years building consumer products: AI-powered CX
              tools, 0-to-1 platform builds, and full-stack systems across
              retail-tech and consumer internet.
            </p>
          </div>
          ...
          {stats.map((s) => (
            ...
            >
              ...
              <p
                ...
                style={{ fontSize: "2rem", color: "#0A2342", lineHeight: 1 }}
              >
                {s.value}
              </p>
              <p
      ...
      <div className="max-w-6xl mx-auto w-full mt-12">
        <p className="text-xs tracking-widest" style={{ color: "#6B7280" }}>
          SCROLL ↓
        </p>
      </div>
    </section>
